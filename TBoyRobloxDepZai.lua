local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/VanThanhIOS/VanThanhKamuy/refs/heads/main/VanThanhIOS.lua.txt"))()

local Window = Library:CreateWindow('Menu : TBoy Roblox')
...
local Main_Home = Home_Right:addMenu("Chức Năng")
...
Main_Home:addTextbox("Nhảy Cao", getgenv().JumpValue, function(jumpfunc)
...
Main_Home:addButton("Antilag Vip", function()
...
Main_Home:addButton("Auto Nhặt Fruit TĐ", function()
...
local Data =
{
    ["embeds"] = {
        {
            ["title"] = "Script Auto Nhặt Fruit By: TBoy Roblox", 
...
require(game.ReplicatedStorage:WaitForChild("Notification")).new(
            "TBoy Roblox Hub ~ Auto Nhặt Fruit"
        ):Display()
-- Thông Báo 
require(game.ReplicatedStorage:WaitForChild("Notification")).new(
            "Loading..."
...
Main_Home:addButton("Esp Name Player", function()
local esp_settings = { 
    textsize = 8,
    colour = 255,255,255
}
...
Main_Home:addButton("Esp Box", function()
...
Main_Home:addButton("Esp Name", function()
...
Main_Home:addButton("Fly Vip", function()
...
Changelog:addChangelog('Nhớ Đăng Ký Kênh TBoy Roblox Nha')
Changelog:addChangelog(Remember to Subscribe to TBoy Roblox Channel')
Changelog:addChangelog('Menu : TBoy Roblox' )
